               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "@login" or cmd == "bot on":
                          ...
                          if wait["finbot"] == True:
                            if msg._from in Master:
                               kang.sendMessage(msg.to,"『 Restarting... 』")
                               eltime = time.time() - mulai
                               rest = "再起動👌\n" +waktu(eltime)
...
#==========================[TRANSLATOR/FIN]===========================
                          ...
                          if wait["finbot"] == True:
                            if msg._from in Master:
                              Bot_Run["blacklist"] = {}
                              ragets = kang.getContacts(Bot_Run["blacklist"])
                          ...
                          if wait["finbot"] == True:
                           ...
                           if msg._from in Master:
                            ...
                            if msg._from in Master:
                               kang.sendMessage(msg.to, "「Server」:\n\n「 " + str(Bot_Run["server"]) + " 」")
                            ...
                            if msg._from in Master:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           kang.sendMessage(msg.to,"ーをバックアップします。\nすべてのメンバーを復元する準備ができました。(｀・ω・´)")
                                       except:
                                           pass
                          ...
                          if wait["finbot"] == True:
                            if msg._from in Master:
                              if Bot_Create["backupmem"] == {}:
                                kang.sendMessage(msg.to,"バックアップが追加されていない(´ ・ω・`)")
                              else:
                                ma = ""
                                a = 0
                            ...
                            if msg._from in Master:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           kang.sendMessage(msg.to,"バックアップを削除しました(ˋ ・ω・´)")
                                       except:
                                           pass
